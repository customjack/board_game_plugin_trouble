...
[CDN Link (v1.0.3)](https://cdn.jsdelivr.net/gh/customjack/board_game_plugin_trouble@v1.0.3/dist/plugins/trouble-plugin.js)

```
https://cdn.jsdelivr.net/gh/customjack/board_game_plugin_trouble@v1.0.3/dist/plugins/trouble-plugin.js
```
